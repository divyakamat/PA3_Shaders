...
public class ShaderProgram {
    ...
    public ShaderProgram(String vertLocation, String fragLocation) throws LWJGLException {
        ...
        try {
            vertexShaderFileReader = new BufferedReader(new FileReader(vertLocation));
            String line;
        ...
        try {
            fragmentShaderFileReader = new BufferedReader(new FileReader(fragLocation));
            String line;
        ...
        vertex = createShader(vertexShaderSource.toString(), GL_VERTEX_SHADER);
        fragment = createShader(fragmentShaderSource.toString(), GL_FRAGMENT_SHADER);
